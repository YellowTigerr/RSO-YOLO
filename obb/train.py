...
import obb.val as validate  # for end-of-epoch mAP
from models.experimental import attempt_load
from models.yolo import ObbModel
...
from utils.obb.dataloaders import create_dataloader
from utils.obb.loss_tal import ComputeLoss
from utils.obb.metrics import KEYS, fitness
from utils.obb.plots import plot_obb_labels
...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    if pretrained:
        ...
        model = ObbModel(cfg or ckpt['model'].yaml, ch=3, nc=nc).to(device)
        ...
        model = ObbModel(cfg, ch=3, nc=nc).to(device)  # create
    ...
    if RANK in {-1, 0}:
        ...
        if not resume:
            ...
            if plots:
                plot_obb_labels(labels, names, save_dir)
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default= ROOT /'models/obb/yolov9obb.yaml', help='model.yaml path')
    ...
    parser.add_argument('--project', default=ROOT / 'runs/train-obb', help='save to project/name')
